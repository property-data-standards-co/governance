...
The **framing** step is the one most often skipped and most often decisive. A badly framed question ("should we use verifiable credentials?") imports an answer. A well-framed question ("what is the minimum unit of assertion that satisfies R-INDEPENDENCE?") admits options nobody has thought of. **Question framing is reviewed by the architecture group before publication**, precisely because framing is where capture happens most invisibly.
